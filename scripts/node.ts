import { LedgerEthereum, NodeLedgerConnectionFactory, Network } from '../source/index';
...
async function doStuff() {
	...
	const ledgerEthereum = new LedgerEthereum(Network.Main, NodeLedgerConnectionFactory, onConnectLedgerRequest, onOpenEthereumAppRequest, onSwitchLedgerModeRequest, onEnableContractSupportRequest);
